      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div className="space-y-8">
            {roles.map((role) => (
            <div key={role.title} className="relative neon-card p-5 sm:p-6 md:p-8 ml-0 md:ml-16 group">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap items-start justify-between mb-4 md:mb-6 gap-3 sm:gap-4">
                ...
                <span className="max-w-full text-sm text-primary border border-primary/30 px-4 py-2 rounded-full bg-primary/5">
                  {role.period}
                </span>
              </div>
